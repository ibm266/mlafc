...
export const milestones: Milestone[] = [
  ...
  },
  {
    ...
    body: 'LHCH is the United Kingdom\'s largest specialist cardiothoracic centre. It provides a regional electrophysiology service to a population of 2.8 million people across the North West of England - a referral catchment larger than the city of Mumbai\'s Greater Mumbai region. Professor Gupta has been in continuous full-time practice there since.',
    meta: '18+ years and counting',
    photoTitle: 'LHCH',
    photoCaption:
      'Appointed consultant cardiologist & electrophysiologist at Liverpool Heart and Chest Hospital.',
  },
  {
    markerYear: '2009',
    ...
    meta: '5,000+ AF ablations · <1% complication rate',
  ...
  },
  {
    ...
    photoCaption: 'Awarded the NHS National Bronze Clinical Excellence Award.',
  },
  {
    markerYear: '2022',
    ...
    body: 'Five years after Bronze, Professor Gupta is awarded the NHS National Silver Clinical Excellence Award. Only a small fraction of NHS consultants are recognised at this level. The Silver award reflects sustained national-level contribution - not just to clinical practice, but to research, teaching and the wider profession.',
    meta: 'National Silver Award, 2022',
    photoTitle: 'NHS Silver',
    photoCaption:
      'Promoted to NHS National Silver Clinical Excellence Award - a small fraction of consultants reach this.',
  },
  {
    markerYear: '2024',
    markerSub: 'Professor',
