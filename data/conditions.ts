...
export const conditions: Condition[] = [
  ...
  },
  {
    ...
    feelsLike: [
      'You have atrial fibrillation and have been told you need blood-thinning tablets long term',
      'You cannot take anticoagulants, or you have bled while taking them',
      'You want a way to lower stroke risk that does not depend on taking a tablet every day',
    ],
    happening:
  ...
  },
  {
    ...
    title: 'Cardioneuroablation for syncope and dysautonomias',
    feelsLike: [
      'Fainting or near-fainting, sometimes with little or no warning',
      'A slow or pausing heartbeat around the time you pass out',
      'Dizziness, palpitations, or a drop in blood pressure with standing, heat, or after eating',
    ],
    happening:
