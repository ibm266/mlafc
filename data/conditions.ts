...
export const conditions: Condition[] = [
  ...
  },
  {
    ...
    videoSrc: '/videos/conditions/atrial-flutter.mp4',
    posterSrc: '/images/conditions/atrial-flutter-poster.png',
    videoAlt:
      'Schematic animation showing a single electrical signal circling a fixed loop in the right atrium, paired with a fast, regular ECG rhythm strip.',
  },
  {
    id: 'svt',
    ...
    videoAlt:
      'Schematic animation showing an extra electrical pathway creating a short-circuit loop above the heart\u2019s pumping chambers, with a fast, regular ECG rhythm strip.',
  },
  {
    id: 'palpitations',
    ...
    videoAlt:
      'Schematic animation showing a heart with several possible rhythm patterns branching from it, illustrating how palpitations can have different underlying causes.',
    isSymptom: true,
  },
  {
    ...
    videoAlt:
      'Schematic animation showing a heart rhythm strip with a pause, alongside a simplified diagram of blood flow to the brain dipping during the pause.',
    isSymptom: true,
  },
  {
    id: 'bradycardia',
    ...
    videoAlt:
      'Schematic animation showing a slowed electrical signal travelling through the heart\u2019s conduction pathway, paired with a slow ECG rhythm strip.',
  },
];
